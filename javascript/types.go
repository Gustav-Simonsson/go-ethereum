...
func (self *JSEthereum) Transact(fromStr, fromPassStr, recipient, valueStr, gasStr, gasPriceStr, dataStr string) otto.Value {
	r, err := self.XEth.Transact(fromStr, fromPassStr, recipient, valueStr, gasStr, gasPriceStr, dataStr)
	if err != nil {
		fmt.Println(err)
