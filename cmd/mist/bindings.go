...
func (gui *Gui) Transact(from, pass, recipient, value, gas, gasPrice, d string) (string, error) {
	var data string
	if len(recipient) == 0 {
	...
	return gui.xeth.Transact(from, pass, recipient, value, gas, gasPrice, data)
}
